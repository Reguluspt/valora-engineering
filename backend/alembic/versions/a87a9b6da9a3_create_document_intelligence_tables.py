...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["parsed_document_id"], ["parsed_documents.id"], ondelete="RESTRICT"
        ),
    )
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.ForeignKeyConstraint(
            ["source_document_id"], ["generated_documents.id"], ondelete="RESTRICT"
        ),
        sa.ForeignKeyConstraint(
            ["target_document_id"], ["parsed_documents.id"], ondelete="RESTRICT"
        ),
    )
