...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['primary_taxonomy_node_id'], ['taxonomy_nodes.id'], ondelete='RESTRICT'),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['canonical_asset_id'], ['canonical_assets.id'], ondelete='CASCADE'),
        sa.PrimaryKeyConstraint('id')
    )
