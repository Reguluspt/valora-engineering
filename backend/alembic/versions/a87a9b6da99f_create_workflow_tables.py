...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ...
            name="fk_workflow_instances_def",
            ondelete="RESTRICT",
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["workflow_definition_id"],
            ["workflow_definitions.id"],
            name="fk_workflow_transitions_def",
            ondelete="RESTRICT",
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["assigned_to"], ["users.id"], name="fk_workflow_tasks_assignee", ondelete="RESTRICT"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["decided_by"], ["users.id"], name="fk_review_decisions_decider", ondelete="RESTRICT"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["validation_rule_id"],
            ["validation_rules.id"],
            name="fk_validation_issues_rule",
            ondelete="RESTRICT",
        ),
        sa.ForeignKeyConstraint(
            ["resolved_by"], ["users.id"], name="fk_validation_issues_resolver", ondelete="RESTRICT"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["user_id"], ["users.id"], name="fk_user_action_logs_user", ondelete="RESTRICT"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
