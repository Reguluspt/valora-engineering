...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['evidence_file_id'], ['evidence_files.id'], name='fk_supplier_quote_evidences_file', ondelete='RESTRICT'),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['evidence_file_id'], ['evidence_files.id'], name='fk_catalogue_evidences_file', ondelete='RESTRICT'),
        sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['evidence_file_id'], ['evidence_files.id'], name='fk_internet_evidences_file', ondelete='RESTRICT'),
        sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['evidence_file_id'], ['evidence_files.id'], name='fk_image_evidences_file', ondelete='RESTRICT'),
        sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['evidence_file_id'], ['evidence_files.id'], name='fk_email_evidences_file', ondelete='RESTRICT'),
        sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['evidence_file_id'], ['evidence_files.id'], name='fk_evidence_extraction_results_file', ondelete='RESTRICT'),
        sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['evidence_file_id'], ['evidence_files.id'], name='fk_evidence_review_decisions_file', ondelete='RESTRICT'),
        sa.ForeignKeyConstraint(['reviewer_id'], ['users.id'], name='fk_evidence_review_decisions_reviewer', ondelete='RESTRICT'),
        sa.PrimaryKeyConstraint('id')
    )
