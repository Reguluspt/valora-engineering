...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['organization_id'], ['organization_profiles.id'], ondelete='CASCADE'),
        sa.ForeignKeyConstraint(['project_id'], ['projects.id'], ondelete='CASCADE'),
        sa.ForeignKeyConstraint(['import_batch_id'], ['project_asset_import_batches.id'], ondelete='CASCADE')
    )
    ...
    op.create_index('idx_staging_row_batch', 'project_asset_import_staging_rows', ['import_batch_id'])
    op.create_index('idx_staging_row_validation', 'project_asset_import_staging_rows', ['validation_status'])
