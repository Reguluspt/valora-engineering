...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.UniqueConstraint('normalized_alias', 'asset_variant_id', name='uq_alias_normalized_variant'),
        sa.UniqueConstraint('normalized_alias', 'canonical_asset_id', name='uq_alias_normalized_canonical')
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['proposed_asset_variant_id'], ['asset_variants.id'], ondelete='RESTRICT'),
        sa.ForeignKeyConstraint(['proposed_canonical_asset_id'], ['canonical_assets.id'], ondelete='RESTRICT'),
        sa.ForeignKeyConstraint(['proposed_taxonomy_node_id'], ['taxonomy_nodes.id'], ondelete='RESTRICT'),
        sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['identity_candidate_id'], ['identity_candidates.id'], ondelete='CASCADE'),
        sa.PrimaryKeyConstraint('id')
    )
