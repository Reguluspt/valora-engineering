...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['replacement_template_id'], ['document_templates.id'], ondelete='SET NULL'),
    ...
    op.create_table(
        ...
        sa.Column('row_version', sa.Integer(), nullable=False),
        sa.PrimaryKeyConstraint('id'),
        sa.ForeignKeyConstraint(['document_template_id'], ['document_templates.id'], ondelete='RESTRICT'),
        ...
        sa.ForeignKeyConstraint(['replacement_version_id'], ['template_versions.id'], ondelete='SET NULL'),
        sa.UniqueConstraint('document_template_id', 'version_number', name='uq_template_version_no')
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['computed_expression_id'], ['computed_placeholder_expressions.id'], ondelete='SET NULL')
    )
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint('id'),
        sa.ForeignKeyConstraint(['template_version_id'], ['template_versions.id'], ondelete='RESTRICT'),
        sa.ForeignKeyConstraint(['template_placeholder_id'], ['template_placeholders.id'], ondelete='RESTRICT')
    )
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint('id'),
        sa.ForeignKeyConstraint(['document_package_id'], ['document_packages.id'], ondelete='RESTRICT'),
        sa.ForeignKeyConstraint(['generated_document_id'], ['generated_documents.id'], ondelete='RESTRICT')
    )
