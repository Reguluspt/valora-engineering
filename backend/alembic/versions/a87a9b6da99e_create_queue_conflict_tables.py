...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['reviewer_id'], ['users.id'], name='fk_knowledge_queue_reviewer', ondelete='RESTRICT'),
        sa.ForeignKeyConstraint(['claimed_by'], ['users.id'], name='fk_knowledge_queue_claimant', ondelete='RESTRICT'),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['resolved_by'], ['users.id'], name='fk_knowledge_conflicts_resolver', ondelete='RESTRICT'),
        sa.PrimaryKeyConstraint('id')
    )
