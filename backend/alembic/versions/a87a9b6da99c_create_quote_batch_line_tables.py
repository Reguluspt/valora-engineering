...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['canonical_asset_id'], ['canonical_assets.id'], name='fk_quote_batches_canonical', ondelete='RESTRICT'),
        sa.ForeignKeyConstraint(['asset_variant_id'], ['asset_variants.id'], name='fk_quote_batches_variant', ondelete='RESTRICT'),
        sa.ForeignKeyConstraint(['created_by'], ['users.id'], name='fk_quote_batches_creator', ondelete='RESTRICT'),
        sa.ForeignKeyConstraint(['approved_by'], ['users.id'], name='fk_quote_batches_approver', ondelete='RESTRICT'),
        sa.ForeignKeyConstraint(['previous_quote_batch_id'], ['quote_batches.id'], name='fk_quote_batches_previous', ondelete='RESTRICT'),
    ...
    op.create_table(
        ...
        sa.Column('status', sa.String(length=50), nullable=False),
        sa.ForeignKeyConstraint(['quote_batch_id'], ['quote_batches.id'], name='fk_quote_lines_batch', ondelete='RESTRICT'),
        sa.ForeignKeyConstraint(['evidence_file_id'], ['evidence_files.id'], name='fk_quote_lines_evidence', ondelete='RESTRICT'),
        sa.PrimaryKeyConstraint('id')
    )
