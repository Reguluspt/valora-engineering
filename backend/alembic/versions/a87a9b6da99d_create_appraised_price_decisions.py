...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["canonical_asset_id"],
            ["canonical_assets.id"],
            name="fk_appraised_price_canonical",
            ondelete="RESTRICT",
        ),
        sa.ForeignKeyConstraint(
            ["asset_variant_id"],
            ["asset_variants.id"],
            name="fk_appraised_price_variant",
            ondelete="RESTRICT",
        ),
        sa.ForeignKeyConstraint(
            ["quote_batch_id"],
            ["quote_batches.id"],
            name="fk_appraised_price_quote_batch",
            ondelete="RESTRICT",
        ),
        sa.ForeignKeyConstraint(
            ["created_by"], ["users.id"], name="fk_appraised_price_creator", ondelete="RESTRICT"
        ),
        sa.ForeignKeyConstraint(
            ["approved_by"], ["users.id"], name="fk_appraised_price_approver", ondelete="RESTRICT"
        ),
