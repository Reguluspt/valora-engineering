...
- [Active isolated S3 spike](plan/valora-storage-s3-spike-001.md) — G2/G3 are complete; the [G4 preflight packet](implementation/VALORA_STORAGE_S3_G4_PREFLIGHT_PACKET.md) freezes the no-network harness and intended live boundary for static review. G5/G6, credentials, AWS requests and cloud cost remain closed.
